...
{
public:
	FileTransferDownLoadTask(const QString& taskid, const QString& filepath_dir = "");
...
public:
	...
	void RegisterTransInfo(const QString& filepath, uint32_t filesize); // 使用提前注册好的传输信息，而非被动接收对方的信息，在确认信息时执行校验行为
protected:
